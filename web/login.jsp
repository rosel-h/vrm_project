                ...
                <form id="loginform" class="form-horizontal" action="Login" method="post">
                    ...
                    <div style="margin-top:10px" class="form-group">
                        <div class="col-sm-12 controls">
                            ...
                            <button id="btn-fblogin" class="btn btn-primary" type ="button" onclick="">
                                <a href="window.location.href='https://www.facebook.com/dialog/oauth?client_id=352195078594245&redirect_uri=http://localhost:8181/oauth2fb&scope=email">Connect via Facebook</a>
                            </button>
                        </div>
                    </div>
                </form>
